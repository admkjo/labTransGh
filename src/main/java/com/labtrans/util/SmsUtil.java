...
// Port that is to be used like 8080 or 8000
    ...
    public SmsUtil(String server, int port, String username, String password, String message, String dlr, String type, String destination,
            String source) {
...
// Below example is for sending Plain text
            SmsUtil s = new SmsUtil("smpp2.xxxxxxxx.com", 8080, "tester909",
                    "test11", "test for unicode", "1", "0", "xxxxxxx",
                    "Update");
            s.submitMessage();
// Below example is for sending unicode
            SmsUtil s1 = new SmsUtil("smpp2.xxxxxxxx.com", 8080, "xxxx",
